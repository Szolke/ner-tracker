...
export default function Dashboard({ darkMode, toggleDarkMode }) {
      ...
      <div className="flex justify-between items-start mb-2">
        ...
        <div className="flex items-center gap-1.5 opacity-0 group-hover:opacity-100 transition">
          ...
          <button onClick={e=>{e.stopPropagation();shareCase(c);}}
            title="Megosztás" className="p-1 rounded opacity-40 hover:opacity-100">
  ...
  const TABS = [
    ...
    {id:'cases',          label:'🗺️ Ügyek'},
    {id:'timeline',       label:'📅 Idővonal'},
    {id:'investigations', label:'🔍 Nyomozások'},
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="p-6">
            ...
            <div className="space-y-6">
              ...
              {watchedCases.length > 0 && (
                <P>
                  <h3 className="font-semibold mb-4 flex items-center gap-2">
                    <Star className="w-4 h-4 text-yellow-400" fill="currentColor"/> Követett ügyek ({watchedCases.length})
                  </h3>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-5">
                <div className="xl:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <P><h3 className="font-semibold mb-4 flex items-center gap-2"><Calendar className="w-4 h-4"/>Évente</h3>
              ...
              {/* Recent */}
              <P><h3 className="font-semibold mb-4 flex items-center gap-2"><Clock className="w-4 h-4"/>Legújabb ügyek</h3>
            ...
            <div className="space-y-5">
              <P>
                <div className="flex items-center gap-2 mb-4"><Search className="w-4 h-4 opacity-40"/>
                  <input type="text" placeholder="Keresés ügy vagy személy neve szerint..."
          ...
          {activeTab==='timeline' && (
            <div className="space-y-6">
              <P>
                <h3 className="font-semibold mb-4 flex items-center gap-2"><Calendar className="w-4 h-4"/>Ügyek idővonala</h3>
          ...
          {activeTab==='investigations' && (
            <div className="space-y-5">
              <P>
                <h3 className="font-semibold mb-4 flex items-center gap-2"><Network className="w-4 h-4"/>Kapcsolati háló
                  <span className="text-xs font-normal opacity-40 ml-1">— fizikai szimuláció · kattints</span></h3>
      ...
      <div className="flex justify-between items-start mb-4">
        ...
        <div className="flex items-center gap-2">
          <button onClick={()=>toggleWatch(c.id)}
            title={watched.has(c.id)?'Eltávolítás a követettekből':'Követés'}
          ...
          <button onClick={()=>shareCase(c)} title="Link másolása / Megosztás"
